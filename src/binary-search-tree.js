...
class BinarySearchTree {
  ...
  has(data) {
    function travers(currentNode) {
      ...
      else if (currentNode.data > data) return travers(currentNode.leftChild);
      else return travers(currentNode.rightChild);
    }
  ...
  find(data) {
    function travers(currentNode) {
      ...
      if (currentNode.data > data) return travers(currentNode.leftChild);
      else return travers(currentNode.rightChild);
    }
  ...
  remove(data) {
    function travers(currentNode, prevNode) {
      if (currentNode == null) return null;
      if (currentNode.data == data) return { node: currentNode, prev: prevNode };
      if (currentNode.data > data) return travers(currentNode.leftChild, currentNode);
      else return travers(currentNode.rightChild, currentNode);
    }
    ...
    function deleteOneChildNode(node, prev) {
      let newNode = null;
      if (node.leftChild) newNode = node.leftChild;
      else if (node.rightChild) newNode = node.rightChild;
    ...
    else deleteTwoChild.call(this, node, prev);
  }
